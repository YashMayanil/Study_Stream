    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-20">
      ...
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="glass-card rounded-2xl p-8 shadow-2xl shadow-black/40">
          ...
          <button className="w-full py-3 glass-card border border-white/8 hover:border-white/15 rounded-xl text-sm text-slate-300 hover:text-white transition-all duration-200 flex items-center justify-center gap-3">
